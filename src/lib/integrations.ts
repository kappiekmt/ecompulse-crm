  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        kind: "secret",
        placeholder: "xoxb-…",
        helper: "Optional. Required only if you want bot-style messages or DMs. Webhook URLs are simpler for one-way notifications.",
        optional: true,
      },
      { key: "default_channel", label: "Default Channel", kind: "text", placeholder: "#sales", optional: true },
    ],
  },
  {
    provider: "stripe",
